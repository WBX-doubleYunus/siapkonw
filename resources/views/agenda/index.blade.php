                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="#" class="btn btn-danger btn-sm delete" data-id="{{$dt->id}}" data-nama="{{$dt->judul}}">Hapus</a>
...
<script>
    $('.delete').click(function() {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    window.location = "/agenda/delete/" + agendaid + ""
                    swal("Data Agenda telah dihapus!", {
                        icon: "success",
                    });
                } else {
                    swal("Data Agenda tidak terhapus!");
                }
            });
    });
</script>
